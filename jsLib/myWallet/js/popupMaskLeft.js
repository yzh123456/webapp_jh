...
let stImg = {position:"fixed", width:"4rem", left:"1rem", top:"6.12rem", zIndex:"10"};

export class PopupMaskLeft extends Component {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <img src="../images/pic_online_balance_2x.png" style={stImg} />
            </div>
        )
    }
}