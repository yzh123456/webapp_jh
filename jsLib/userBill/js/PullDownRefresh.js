...
export class PullDownRefresh extends Component {
    ...
    componentWillUnmount() {
        ...
        listenEl.removeEventListener("touchstart",this.touchMoveHandler);
        listenEl.removeEventListener("touchstart",this.touchEndHandler);
    }
    ...
    render() {
        return (
            <div>
                ...
                <div ref="refreshing" style={stRefresh} > <img src="./images/pic_refreshing.gif" style={stImg} />
                    &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;  <span>正在刷新...</span>
                </div>
            </div>
        )
