/**
 * Created by yqx on 2017/4/27.
 */
'use strict';
let path = require("path");
let webpack = require("webpack");
let appScanEntry = require("./appEntryConfig");
//import {appScanEntry} from "./appEntryConfig";
let node_modules_dir = path.join(__dirname, 'node_modules');
//指定编译源码目录地址
let staticRoot = path.resolve(__dirname, "./src");
//指定编译后输出目录
let outputPath = path.resolve(__dirname, "./src/qrcode/js");
let deps = [
...
let config =  {
    //devtool : "source-map",
    entry: appScanEntry.appScanEntry,
    output: {
